...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    print(f"La duracion promedio de las peliculas es: {promedio}")
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    anio = int(input("Ingrese el año para consultar estrenos: "))
    estrenos = mod.encontrar_estrenos(p1, p2, p3, p4, p5, anio )
    
    print(f"Estrenos: {estrenos}")
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    print(f"Cantidad de peliculas 18+: {cantidad}")
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    nueva_hora = int(input("Ingrese la nueva hora (Formato 24 horas): "))
    nuevo_dia = input("Ingrese nuevo dia de la semana: ")
    control_horario = input ("Desea controlar el horario? (si/no): ")
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if nom_peli == 'Shrek':
        print("Se puede invitar al invitado a ver la pelicula")
    elif nom_peli == 'Get Out' or 'Icarus':
        edad_invitado = int(input("Ingrese la edad del invitado: "))
        if edad_invitado < 18:
            autorizacion = input("El invitado tiene autorizacion de sus padres? (si/no): ")
            if autorizacion == 'si':
                print("Se puede invitar al invitado a ver la pelicula")
            else:
    ...
    elif nom_peli == 'The Empire Strikes Back':
        edad_invitado = int(input("Ingrese la edad del invitado: "))
        if edad_invitado < 7:
            autorizacion = input("El invitado tiene autorizacion de sus padres? (si/no): ")
            if autorizacion == 'si':
    ...
    puede_invitar = mod.decidir_invitar(pelicula, edad_invitado, autorizacion)
    if puede_invitar:
        print("Se puede invitar al invitado a ver la pelicula")
    else:
        print("No se puede invitar a ver la pelicula")
